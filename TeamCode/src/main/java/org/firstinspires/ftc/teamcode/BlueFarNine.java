...
public class BlueFarNine extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            FROMSTARTTOFIRSTSHOOT = follower.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(108.5))
                    .build();
            ...
            FIRSTSHOOTTOINTAKEPPG = follower.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(108.5), Math.toRadians(180))
                    .build();
            ...
            /*THIRDSHOOTTOGPP and GPPTOLASTSHOOT are unused in this auton
            ...
            PARK = follower.pathBuilder()
                    ...
                    .setConstantHeadingInterpolation(Math.toRadians(108.5))
                    .build();
        }
    }
    ...
    private static final Pose FIRST_SHOOT_POSE = new Pose(54, 14, Math.toRadians(108.5));
    private static final Pose SECOND_SHOOT_POSE = new Pose(54, 14, Math.toRadians(108.5));
    private static final Pose THIRD_SHOOT_POSE = new Pose(54, 14, Math.toRadians(108.5));
    private static final Pose LAST_SHOOT_POSE = new Pose(54, 14, Math.toRadians(71.5));
